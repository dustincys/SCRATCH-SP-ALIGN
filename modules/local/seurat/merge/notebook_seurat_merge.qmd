---
title: "Module - Merging post-QC data"
description: | 
  Description
execute:
  freeze: auto
...
params:
  project_name: 'Test'
  input_qc_approved: 'SRX5128504_seurat_object.RDS;SRX5128478_seurat_object.RDS'
  input_exp_table: 'samplesheet.valid.csv'
  n_threads: 8
  n_memory: 16
...
if(auto_save) {
  ...
  saveRDS(seurat_object, file = paste0(project_name, '_merged_object.RDS'))
